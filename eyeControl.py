...
while True:
    ...
    if all_face_landmark_points:
        one_face_lanmdmark_points = all_face_landmark_points[0].landmark
        for id,landmark_point in enumerate(one_face_lanmdmark_points[474:478]):
        ...
        left_eye = [one_face_lanmdmark_points[145],one_face_lanmdmark_points[159]]
